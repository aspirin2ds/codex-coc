...
This reference is a portable working summary for the skill package. Keep it aligned with the underlying game rules and CLI behavior, but do not assume access to repo-level docs outside this skill folder.
