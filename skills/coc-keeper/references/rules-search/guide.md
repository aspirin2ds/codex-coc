...
2. Read [source-map.md](source-map.md) to choose the smallest relevant source set.
...
Use the chapter map in [source-map.md](source-map.md).
If you need exact terms or grep seeds, use [search-patterns.md](search-patterns.md).
If the question is player-facing, start with [player-rules-guide.md](player-rules-guide.md).
If the question is keeper-facing, start with [keeper-rules-guide.md](keeper-rules-guide.md).
